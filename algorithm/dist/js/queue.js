...
var Node = function Node(value, next, prev) {
...
var _linked_list = __webpack_require__(23);

var _linked_list2 = _interopRequireDefault(_linked_list);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Queue = function (_LinkedList) {
	(0, _inherits3.default)(Queue, _LinkedList);

	function Queue() {
		(0, _classCallCheck3.default)(this, Queue);
		return (0, _possibleConstructorReturn3.default)(this, (Queue.__proto__ || (0, _getPrototypeOf2.default)(Queue)).call(this));
	}
...
function queue_test() {
	// 排序
	var a = [0, 87, 1, 7, 98, 19, 19, 77, 55, 75, 12, 10, 100, 1000, 79, 234, 543, 43, 5, 23, 543, 43, 12, 7, 43, 654, 62, 62, 46, 2643, 87];
	...
	for (var i = 0; i < 4; i++) {
		...
		try {
			for (var _iterator = (0, _getIterator3.default)(a), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
				...
				var index = Math.floor(n / Math.pow(10, i) % 10);
				queues[index].push(n);
			}
		} catch (err) {
		...
		try {
			for (var _iterator2 = (0, _getIterator3.default)(queues), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				var q = _step2.value;

				var _n = q.shift();
				while (!isNaN(parseFloat(_n))) {
					r.push(_n);
					_n = q.shift();
				}
			}
